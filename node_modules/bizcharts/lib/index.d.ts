...
export declare const Util: {
    ...
    reduce: <T_4, G>(arr: G[], fn: (result: T_4, data: G, idx: number) => T_4, init: T_4) => T_4;
    ...
    groupToMap: (data: any, condition: any) => import("@antv/util/lib/group-by").ObjectType<unknown> | {
        0: any;
    };
